"""SentimentAgent Microservice — port 8012."""
import asyncio, sys
...
app = FastAPI(title="SentimentAgent", version="3.0.0")
...
@app.get("/health")
async def health():
    return {"status": "ok", "agent": "SentimentAgent", "port": 8012}

@app.post("/a2a")
async def a2a_endpoint(req: A2ARequest):
    try:
        from app.agent.sub_agents import SentimentAgent
